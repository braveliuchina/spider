...
@Data
//@Component
public class TyrbRepoProcessor implements PageProcessor {
	...
	public TyrbRepoProcessor(SpiderConfigDao spiderConfigDao) {
	...
	public Site getSite() {
		...
		this.setSpiderConfig(spiderConfigDao.getConfig("太原日报"));
	...
	public void process(Page page) {
        ...
        for(Selectable node : nodes){
        	...
        	String contentAll = "<div><span style='font-weight:bold;font-size:22px;'>" + introTitle + "</span></div>" +
        			"<div>" + author + "</div>" +
        			"<div><span style='font-weight:bold;font-size:16px;'>" + title + "</span></div>" +
        			"<div>" + subTitle + "</div>" +
        			"<div>" + source + "</div>" +
        			"<div>" + zhuanBan + "</div>" +
        			"<div>" + property + "</div>" +
